        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="section-heading mb-6">
              Uncover the Story of<span className="highlight"> Scancode Auto ID Technology</span>
            </h2>
            <div className="prose prose-lg text-gray-600 space-y-6">
              <p>
                At Scancode Auto ID Technology Pvt Ltd, we aspire to be a leading presence in the national auto identification and product label manufacturing industry. Established in 2016, we have leveraged our expertise in Automatic Identification and Data Capture (AIDC) to develop innovative, reliable solutions that meet the evolving needs of a wide range of industries. Our commitment to quality and product enables us to deliver high-performance products, exceptional customer service, and dependable technical support to clients across India and beyond.
              </p>
              <p>
                In 2021, we expanded our capabilities by acquiring an established label manufacturing company, enhancing our reach and expertise in product labeling. Recently, we invested in advanced Multitec S1-8 Colour LED UV machines, allowing us to deliver industry-leading labeling solutions with unmatched clarity and durability. Our mission is clear: to provide comprehensive, customized auto identification and product labeling solutions that empower businesses to optimize their operations, boost efficiency, and elevate their performance. With a strong commitment to excellence, Scancode Auto ID Technology Pvt Ltd is dedicated to creating lasting value for our clients, adding a competitive edge to their enterprises.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-9xl mx-auto">
          <div className="  md:p-12 text-center">
            <p className="text-4xl font-bold text-gray-800 leading-relaxed mb-6 text-center">Driving Innovation through
              Reliable <span className="relative z-10 text-[#EF7F1A] hover:text-gray-800 transition-colors duration-300 cursor-default"> Advanced Manufacturing<span className="absolute bottom-0 left-0 w-full h-3 bg-[#EF7F1A]/20 z-0 transform -rotate-1" /></span>
            </p>
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              At Scancode Auto ID Technology Pvt. Ltd., our infrastructure is the cornerstone of our commitment to excellence in product labels and auto ID solutions. We understand that leveraging top-quality raw materials and state-of-the-art manufacturing technologies leads to exceptional products that empower businesses.
            </p>
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              As a leading manufacturer in the auto ID industry, we adhere to strict quality standards, ensuring our labels and solutions comply with ISO and industry-specific regulations. Our facility is equipped with advanced printing technologies and dedicated testing equipment that guarantee product and reliability in every product we produce.
            </p>
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              Most of our labeling components are produced in-house, allowing us to maintain tight control over quality and turnaround times. We also partner with reputable specialists for essential processes such as custom label design, material testing, and compliance checks. This comprehensive approach enables us to deliver high-quality, innovative solutions that meet the diverse needs of our clients.
            </p>
            <p className="text-gray-700 text-lg leading-relaxed">
              By prioritizing quality and technological advancement, Scancode is dedicated to helping businesses enhance their operations and achieve lasting success.
            </p>
          </div>
        </div>
      </section>
