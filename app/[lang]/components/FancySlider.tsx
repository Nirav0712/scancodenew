...
const SliderSection = styled.section`
  ...
  clip-path: ellipse(78% 82% at 50% 0%);
...
const SliderTitle = styled.h2`
  font-size: clamp(20px, 10vw, 60px); /* Slightly smaller for stacked view */
  font-weight: 500;
  color: #fff;
  line-height: 1.1;
...
const FancySlider: React.FC<{ dict: any }> = ({ dict }) => {
    ...
    return (
        <>
            ...
            <div className="absolute -bottom-4 md:bottom-14 left-1/2 -translate-x-1/2 w-[calc(100%-40px)] max-w-5xl translate-y-1/4 z-20">
