      ...
      <div className={`relative z-10 max-w-5xl mx-auto px-6 ${heightClasses[height]}`}>
        {withAnimation ? (
          ...
          >
            ...
            <motion.h1
              variants={fadeInUpVariants}
              className="font-bold text-white tracking-tight leading-tight !whitespace-nowrap !overflow-hidden !text-ellipsis max-w-full"
              style={{ fontSize: "clamp(45px, 4vw, 85px)" }}
            >
              {title}
            </motion.h1>
