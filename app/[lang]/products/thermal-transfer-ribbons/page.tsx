          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-gray-700 text-lg text-center leading-relaxed mb-6">
                Our <a href="https://www.scancodeautoid.com/en-US/thermal-transfer-ribbons" title="Thermal Transfer Ribbons" className="text-[#FF7F1A] hover:underline">Thermal Transfer Ribbons</a> deliver superior print quality, durability, and consistent performance, ensuring sharp, long-lasting prints for all your labeling needs. With a wide range of grades and compatibility with various printers, we provide the ideal solution for industries seeking reliable and cost-effective printing options.
              </p>
            </div>
