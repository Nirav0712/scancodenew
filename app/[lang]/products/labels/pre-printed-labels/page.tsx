              ...
              <div className="lg:p-14">
                ...
                <div className="space-y-6">
                  <p className="text-gray-700 text-lg leading-relaxed border-l-4 border-[#EF7F1A] pl-4">
                    Scancode ID's <a href="https://www.scancodeautoid.com/en-US/products/labels/pre-printed-labels" title="Pre Printed Labels" className="text-[#FF7F1A] hover:underline">Pre-Printed Labels</a> deliver high-quality, ready-to-use labeling solutions that save time and enhance brand consistency. Tailored to meet specific business needs, these labels are pre-designed with your branding, information, and compliance requirements in mind. With Scancode ID's expertise, you receive labels that not only meet industry standards but also make an impact, ensuring each label reflects your brand's quality and attention to detail.
                  </p>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-gray-700 text-lg text-center leading-relaxed mb-6">
                Our <a href="https://www.scancodeautoid.com/en-US/products/labels/pre-printed-labels" title="Pre Printed Labels" className="text-[#FF7F1A] hover:underline">Pre-Printed Labels</a> offer a ready-made solution tailored to fit your business needs. Designed with product, these labels provide consistent, professional appearance across your products, making them ideal for branding, identification, and compliance in various industries.
              </p>
            </div>
