  ...
  return (
    <main className="bg-white">
      <PageHero
        ...
        backgroundImage="/images/lable-design/shrink-sleevesbg.png"
      />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="lg:p-14">
                <h2 className="text-4xl lg:text-5xl font-bold text-gray-800 leading-tight mb-8">
                  Custom
                  <span className="relative z-10 text-[#EF7F1A] hover:text-gray-800 transition-colors duration-300 cursor-default block ">Shrink Sleeves
                    <span className="absolute -bottom-1 left-0 w-80 h-3 bg-[#EF7F1A]/20 z-0 transform" />
                ...
                <div className="space-y-6">
                  <p className="text-gray-700 text-lg leading-relaxed border-l-4 border-[#EF7F1A] pl-4">
                    At <a href="https://www.scancodeautoid.com/en-US/autoidsolution" title="Scancode Auto ID Solutions" className="text-[#FF7F1A] hover:underline">Scancode Auto ID Solutions</a>, we specialize in producing high-quality
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-gray-700 text-lg text-center leading-relaxed mb-6">
                Our <a href="https://www.scancodeautoid.com/en-US/products/labels/shrink-sleeves" title="Shrink sleeves" className="text-[#FF7F1A] hover:underline">shrink sleeves</a> provide full 360-degree branding, vibrant high-quality prints, and durable protection, tailored to meet the unique needs of your product. With options for tamper-evident features and eco-friendly materials, we offer a complete packaging solution designed to elevate and secure your brand.
              </p>
            </div>
        ...
        <section className="py-16 container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-gray-700 text-lg leading-relaxed mb-6 text-center">
              At <a href="https://www.scancodeautoid.com/en-US/autoidsolution" title="scancodeautoid" className="text-[#FF7F1A] hover:underline">Scancode Auto ID Solutions</a>, we combine years of industry expertise with advanced label printing technology and a strong commitment to quality, making our solutions ideal for a wide range of business and packaging needs. Our labels are carefully designed to enhance your product's visibility with sharp print quality, vibrant colors, and precise detailing. From barcode labels and QR code labels to product and packaging labels, we ensure durability and resistance to factors like moisture, heat, and handling. This guarantees that your labels remain clear, professional, and intact throughout the entire supply chain—from production to the end customer.
            </p>
            <p className="text-gray-700 text-lg leading-relaxed mb-6 text-center">
              In addition to visual appeal and durability, we prioritize compliance with industry standards by offering advanced label printing solutions, including tamper-evident labels that enhance product safety and authenticity—especially for sectors like food, pharmaceuticals, and cosmetics. Our solutions also support eco-conscious businesses with sustainable and recyclable label materials that help reduce environmental impact. With a strong focus on customization, we work closely with each client to design labels that truly reflect their brand identity, ensuring a perfect fit for various packaging types and surfaces. Trust <a href="https://www.scancodeautoid.com/en-US/products/labels" title="Scancode Auto ID Solutions - Barcode & Label Printing" className="text-[#FF7F1A] hover:underline">label</a> printing solutions that combine strong visual appeal, durability, security, and compliance for a professional and reliable product presentation.
            </p>
          </div>
        </section>
