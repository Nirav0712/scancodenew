...
const PRODUCT_CATEGORIES = [
  ...
  },
  {
    ...
    description:
      "Shrink sleeves provide a high-impact 360-degree labeling solution that covers the entire surface of a product. They are perfect for enhancing product visibility and branding on bottles, containers, and uniquely shaped packaging. With vibrant print quality and durability, shrink sleeves help products stand out on shelves.making them perfect for enhancing branding and visibility on bottles, containers, and uniquely shaped packaging with vibrant print quality and durability.",
    image: "/images/lables/shrink-sleeve.webp",
    features: [
      "360-degree branding",
      "Tamper-evident options",
      "Available in PVC, PET, and OPS",
    ],
    ...
    <main className="bg-white">
      ...
      <section className="py-20 max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto mb-16">
          <h2 className="text-3 md:text-4xl font-bold text-gray-900 mb-8">
          ...
          <p className="text-gray-500 md:text-base leading-relaxed max-w-5xl mx-auto px-4 text-2xl ">
            ...
            economic value and reliable printability; polypropylene(PP) and
            polyethylene(PE) f ilms in white, clear, and silver for both
            durability and elegance; PET films for their resistance to chemicals
            and heat; and ultra-durable synthetic f ilms suited for industrial
            applications. For high-security needs, we offer tamper-evident,
            void, and ultra-destructive <a href="https://www.scancodeautoid.com/en-US/products/labels" title=" Labels" className="text-[#FF7F1A] hover:underline">labels</a>, as well as specialty materials
            engineered for cryogenic, high-temperature, and chemical exposed
            environments.
          </p>
