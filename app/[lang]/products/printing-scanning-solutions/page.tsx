...
const PRODUCT_CATEGORIES = [
  {
    ...
    features: [
      "Industrial high-volume printers",
  ...
  },
  {
    ...
    description:
      "Barcode scanners are essential devices designed to read and decode barcodes quickly and accurately, enabling businesses to streamline operations and improve efficiency. These devices play a crucial role in modern industries by automating data entry processes, reducing human errors, and enhancing productivity.Barcode scanners are widely used in industries such as retail, logistics, healthcare, and inventory management. They help automate data entry, reduce human errors, and improve operational efficiency.",
    image: "/images/lables/barcodescan.png",
    hoverImage: "/barcode-printer-hover.png",
    features: [
      "Corded and cordless models",
      "Omnidirectional reading",
      "Ruggedized for drops",
    ],
  ...
  },
  {
    ...
    image: "/images/printers/mobileprinter.png",
      ...
      <section className="py-20 max-w-6xl mx-auto px-6 lg:px-8">
        <div className="text-center max-w-9xl mx-auto mb-16">
          ...
          <p className="text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed w-full max-w-9xl mx-auto px-6 text-center">
            Explore <a href="https://www.scancodeautoid.com/en-US" title="Scancode Auto ID Solutions" className="text-[#FF7F1A] hover:underline">Scancode Auto ID Solutions</a> range of Printing & Scanning Solutions designed to meet the
            demanding needs of modern businesses. Our solutions include
            high-performance printers, thermal transfer ribbons, in-mold labels,
            and more, all engineered for reliability and high productivity. From
            barcode labeling to document scanning, we offer industry-leading
            products that enhance efficiency and ensure accurate, high-quality
            results across diverse applications. Discover the perfect solution
            to streamline your operations today.
          </p>
          ...
          {PRODUCT_CATEGORIES.map((category, index) => (
            ...
            >
              ...
              <div className="w-full lg:w-1/2">
                <div
                  onClick={() =>
                    handleCategoryClick(category.pagePath, category.title)
                  }
              ...
              <div className="w-full lg:w-1/2 lg:px-8 text-center flex flex-col items-center">
                ...
                <Link href={category.pagePath} className="group inline-block">
      ...
      <section className="bg-section-bg2 py-20 mt-10">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-600 mb-10">
            Our solutions engineers can build a custom package combining
