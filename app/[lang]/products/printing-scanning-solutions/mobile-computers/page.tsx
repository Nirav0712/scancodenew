   ...
   const benefits = [
      {
         ...
         description: 'Enjoy robust processing capabilities for smooth multitasking and application use.',
      },
      {
         icon: <Printer className="w-8 h-8 text-blue-600" />,
         title: 'Portability On-the-Go Access',
         description: 'Lightweight and compact design allows effortless mobility in various environments.',
      },
      {
         icon: <Users className="w-8 h-8 text-blue-600" />,
         title: 'Rugged and Durable Build',
         description: 'Built to endure tough conditions, ensuring reliability in demanding settings.',
      },
      {
         icon: <Shield className="w-8 h-8 text-blue-600" />,
         title: 'Consistent Connectivity',
         description: 'Features Wi-Fi, Bluetooth, and cellular options for reliable data access.',
      },
   ];
               ...
               <div className="container mx-auto px-4 max-w-7xl">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                     ...
                     <div className="relative h-full">
                        ...
                        <div className="relative rounded-3xl overflow-hidden shadow-2xl transform hover:scale-[1.02] transition-transform duration-300">
                           <img
                              src="/images/lable-design/mobile-computers.jpg"
                  ...
                  <div className="space-y-2 leading-relaxed border-l-4 border-[#EF7F1A] ml-16 mt-10">
                     <p className="text-gray-700 text-xl pl-4 text-justify">
                        Mobile Computers & Tablets from <a href="https://www.scancodeautoid.com/en-US/products/printing-scanning-solutions/mobile-computer" title="Scancode Auto ID Solutions - Barcode & Label Printing" className="text-[#FF7F1A] hover:underline">Scancode Auto ID</a> are designed to boost productivity in various industries, including retail, logistics, and field service. These versatile devices combine powerful computing capabilities with portability, allowing your workforce to access real-time data and applications on the go.
                     </p>
                     <br />
                     <p className="text-gray-700 text-xl pl-4 text-justify">
                        Equipped with advanced technology, our<a href="https://www.scancodeautoid.com/en-US/products/printing-scanning-solutions/mobile-computer" title="Scancode Auto ID Solutions - Barcode & Label Printing" className="text-[#FF7F1A] hover:underline">mobile computers</a> and tablets ensure seamless connectivity, high-performance processing, and user-friendly interfaces. Their rugged designs withstand challenging environments, making them ideal for both indoor and outdoor use. By integrating these devices into your operations, you empower your team to make informed decisions quickly, ultimately improving efficiency and customer satisfaction.
                     </p>
                  </div>
               </div>
...
export default MobileComputersPage;